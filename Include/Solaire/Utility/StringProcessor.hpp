...
namespace Solaire{ namespace Utility{ namespace Strings{
    ...
    static const char* ParseNumber(const char* const aBegin, const char* const aEnd, double& aOutput, const bool aCanBeNegative, const bool aCanBeDecimal){
	 ...
	 private:
		 ...
		 bool mIsNegative;						// Set to true if the value is determined to be negative
		 bool mIsExponentNegative;				// Set to true if the exponent is determined to be e-N

		 int64_t mValue;						// The main value body
		 int64_t mExponentValue;				// The value of the exponent
		 int64_t mDecimalValue;					// The value of the decimal places

		 const char* mValueBegin;				// Set to the first character in the value
		 const char* mExponentBegin;			// Set to the first character in the exponent value
		 const char* mDecimalBegin;				// Set to the first character in the decimal value
