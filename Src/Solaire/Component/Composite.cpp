...
namespace Solaire{
	...
	extern "C" {
		SOLAIRE_EXPORT_API Composite* SOLAIRE_EXPORT_CALL CreateComposite(Allocator& aAllocator) {
			return new(aAllocator.Allocate(sizeof(CompositeImplementation))) CompositeImplementation(aAllocator);
		}
	}
}
