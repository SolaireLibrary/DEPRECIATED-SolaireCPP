...
namespace Solaire{ namespace Units{
	...
	class Metric : public BaseConverter<MetricPrefix, CONVERSION>
	{
	private:
	...
	public:
		...
		Metric(const BaseConverter<unit_t, conversion_t>& aOther) :
			BaseConverter(aOther.Get(GetIntermediaryUnit()))
		{
			ConfigureProperties();
		}
	};
